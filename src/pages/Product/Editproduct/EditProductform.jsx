                        ...
                        <img
                          src={
                            values.product_image1 == data.data.product_image1
                              ? `https://mobile-backend-8rzi.onrender.com/uploads/images/${data.data.product_image1}`
                        ...
                        <img
                          src={
                            values.product_image2 == data.data.product_image2
                              ? `https://mobile-backend-8rzi.onrender.com/uploads/images/${data.data.product_image2}`
                        ...
                        <img
                          src={
                            values.product_image3 == data.data.product_image3
                              ? `https://mobile-backend-8rzi.onrender.com/uploads/images/${data.data.product_image3}`
                        ...
                        <img
                          src={
                            values.product_image4 == data.data.product_image4
                              ? `https://mobile-backend-8rzi.onrender.com/uploads/images/${data.data.product_image4}`
      ...
      <div className="row">
        ...
        {variantdata.data.map((item, index) => (
          <div className="col-3">
            ...
            <div class="card2">
            <img
                          src={`https://mobile-backend-8rzi.onrender.com/uploads/images/${item.product_image1}`}
                          alt="zxcvbnm"
                          width="100%"
                          height="100%"
                          style={{ cursor: "pointer" }}
